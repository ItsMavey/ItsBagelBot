...
func (_c *UserCreate) SetConfigsID(id int) *UserCreate {
	_c.mutation.SetConfigsID(id)
	return _c
}

// SetNillableConfigsID sets the "configs" edge to the Configs entity by ID if the given value is not nil.
func (_c *UserCreate) SetNillableConfigsID(id *int) *UserCreate {
	if id != nil {
		_c = _c.SetConfigsID(*id)
	}
	return _c
}

// SetConfigs sets the "configs" edge to the Configs entity.
func (_c *UserCreate) SetConfigs(v *Configs) *UserCreate {
	return _c.SetConfigsID(v.ID)
}
...
func (_c *UserCreate) AddTimerIDs(ids ...int) *UserCreate {
	_c.mutation.AddTimerIDs(ids...)
	return _c
}

// AddTimers adds the "timers" edges to the Timers entity.
func (_c *UserCreate) AddTimers(v ...*Timers) *UserCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
